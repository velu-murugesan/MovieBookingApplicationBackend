...
public class ShowService {
    ...
    public Show createShow(ShowDTO showDTO) {
        ...
        Movie movie = movieRepository.findById(showDTO.getMovie_id()).orElseThrow(() -> new RuntimeException("No movie found for this id" + " " + showDTO.getMovie_id()));

        Theater theater = theaterRepository.findById(showDTO.getTheater_id()).orElseThrow(() -> new RuntimeException("No theater found for this id" + " " + showDTO.getTheater_id()));
    ...
    public List<Show> getAllShowsByMovie(Long movieId) {
        ...
        else throw new RuntimeException("No more shows found for the movie id" + " " + movieId);
    }
    ...
    public List<Show> getAllShowsByTheater(Long theaterId) {
        ...
        else throw new RuntimeException("NO more shows found for the theater id" + " " + theaterId);
    }

    public Show updateShow(Long id, ShowDTO showDTO) {

       Show show =  showRepository.findById(id).orElseThrow(() -> new RuntimeException("No Movie found for this id" + " " + id));
